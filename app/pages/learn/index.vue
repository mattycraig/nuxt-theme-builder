  ...
  >
    ...
    <template #filters>
      <UButton
        ...
        :aria-label="`Show featured articles only. ${featuredOnly ? 'Currently active' : 'Not active'}.`"
        color="warning"
        size="sm"
      ...
      <UButton
        ...
        :aria-label="`Filter by ${f.label}. ${f.count} articles. ${selectedFormat === f.format ? 'Currently selected' : 'Not selected'}.`"
        color="primary"
        size="sm"
