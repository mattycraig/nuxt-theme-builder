...
// Color Maps ─────────────────────────────────────────────────────────────
// Static color values (OKLCH, Tailwind CSS v4 defaults) for rendering
// swatches in the editor UI and generating CSS variable overrides.
...
// Full shade color maps for chromatic palettes (Tailwind CSS v4 OKLCH defaults)
export const CHROMATIC_HEX_MAP: Record<string, Record<string, string>> = {
  red: {
