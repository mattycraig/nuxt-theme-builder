/**
 * Static color values (OKLCH) from Tailwind CSS v4 defaults.
 *
 * These maps power the editor's swatch rendering and CSS variable generation.
 * Values are sourced from the Tailwind CSS v4 default palette:
 * @see https://tailwindcss.com/docs/customizing-colors
 */

// Neutral Palette Hex Map ─────────────────────────────────────────────────
...
// Chromatic Swatch Hex (shade-500 representative color for each palette) ──
...
// Full Shade Maps for Chromatic Palettes ──────────────────────────────────
...
// Neutral Swatch Hex (shade-500 representative for each neutral) ──────────
