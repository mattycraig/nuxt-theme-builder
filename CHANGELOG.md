...
- **theme-editor:** Enhance theme management with save functionality and section toggling; **theme-store:** add active preset tracking and unsaved changes detection; **theme:** include `createdAt` and `updatedAt` in theme presets for better management; **helpers:** implement `timeAgo` function for relative time display; **tests:** add Playwright for end-to-end testing and implement theme saving tests; **chore:** update `package.json` for Playwright dependencies and scripts and disable devtools in production environment ([332f33f](https://github.com/mattycraig/nuxt-theme-builder/commit/332f33f))
...
- **ci:** Scope ISR route rules to vercel production ([228f8c3](https://github.com/mattycraig/nuxt-theme-builder/commit/228f8c3))
...
- **release:** V1.1.1 ([#11](https://github.com/mattycraig/nuxt-theme-builder/pull/11))
- **release:** V1.3.1 ([#17](https://github.com/mattycraig/nuxt-theme-builder/pull/17))
...
- **e2e:** Fix all nightly and local test failures — release v1.1.0 ([#8](https://github.com/mattycraig/nuxt-theme-builder/pull/8))
